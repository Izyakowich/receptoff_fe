    ...
    <div className='app'>
      <HashRouter>
        <Routes>
          ...
          {isAuth && user.isSuperuser && <Route path="/products/admin/edit/:id/" element={<EditProductPage />} />}
          ...
          {isAuth && user.isSuperuser && <Route path="/claim/admin/" element={<AdminClaimPage />} />}
